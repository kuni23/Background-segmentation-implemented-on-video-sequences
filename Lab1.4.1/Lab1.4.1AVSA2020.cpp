...
int main(int argc, char ** argv)
{
	...
	string baseline_seq[3] = {"fountain01","fountain02", "canoe"};
...
// if (argc==3)	{input=argv[3]);}
	...
	string project_name = "Lab1.4.1AVSA2020"; // project exe name
...
//			namedWindow("ForeGround Mask"); // final fgmask
			...
			double dev_weight = 15; // to set ... //Lab1.1.1-3
			double alpha=0.05; // to set ... //Lab1.1.2-3
			bool selective=true; // true ... //Lab1.1.2-3
			//number of Gaussians, should be the same like in the settings
			int K=25; // to set ... //Lab1.1.3
			bool rgb = false; //true;
			...
			fgseg::bgs avsa_bgs(K, dev_weight, selective, alpha, rgb); //construct object of the bgs class
